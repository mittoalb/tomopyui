...
from tomopyui.backend.io import (
    ...
    RawProjectionsHDF5_APS_32ID,
	RawProjectionsHDF5_APS_2BM,
	RawProjectionsHDF5_APS_7BM,
...
class Import_APS_32ID(ImportBase):
    """"""

    def __init__(self):
        super().__init__()
        self.raw_uploader = RawUploader_APS_32ID(self)
        self.make_tab()
...
class Import_APS_2BM(ImportBase):
    """"""

    def __init__(self):
        super().__init__()
        self.raw_uploader = RawUploader_APS_2BM(self)
        self.make_tab()
...
class Import_APS_7BM(ImportBase):
    """"""

    def __init__(self):
        super().__init__()
        self.raw_uploader = RawUploader_APS_7BM(self)
        self.make_tab()
...
class RawUploader_APS_32ID(UploaderBase):
    """
    Raw uploaders are the way you get your raw data (projections, flats, dark fields)
    into TomoPyUI. It holds a ProjectionsBase subclass (see io.py) that will do all of
    RawProjectionsHDF5_APSyourbeamlinenumber().
    ...
    def __init__(self, Import):
        super().__init__()  # look at UploaderBase __init__()
        self._init_widgets()
        self.projections = RawProjectionsHDF5_APS_32ID()
...
class RawUploader_APS_2BM(UploaderBase):
    """
    Raw uploaders are the way you get your raw data (projections, flats, dark fields)
    into TomoPyUI. It holds a ProjectionsBase subclass (see io.py) that will do all of
    RawProjectionsHDF5_APSyourbeamlinenumber().
    ...
    def __init__(self, Import):
        super().__init__()  # look at UploaderBase __init__()
        self._init_widgets()
        self.projections = RawProjectionsHDF5_APS_2BM()
        self.reset_metadata_to = Metadata_APS_2BM_Raw
        self.Import = Import
        self.filechooser.title = "Import Raw hdf5 File"
        self.filetypes_to_look_for = [".h5"]
        self.files_not_found_str = "Choose a directory with an hdf5 file."
...
class RawUploader_APS_7BM(UploaderBase):
    """
    Raw uploaders are the way you get your raw data (projections, flats, dark fields)
    into TomoPyUI. It holds a ProjectionsBase subclass (see io.py) that will do all of
    RawProjectionsHDF5_APSyourbeamlinenumber().
    ...
    def __init__(self, Import):
        super().__init__()  # look at UploaderBase __init__()
        self._init_widgets()
        self.projections = RawProjectionsHDF5_APS_7BM()
        self.reset_metadata_to = Metadata_APS_7BM_Raw
        self.Import = Import
        self.filechooser.title = "Import Raw hdf5 File"
        self.filetypes_to_look_for = [".h5"]
        self.files_not_found_str = "Choose a directory with an hdf5 file."
